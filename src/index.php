...
<head>
  ...
  <body style="background-color: #D5D2DC">
	<div  id="heading" >
...
echo "<table class='container'>
                  ...
                  <tr>
				   ...
				   <tr>
                      ...
                      <td style='background-color:#222222'><h3>&nbsp&nbsp " . '7.2.0' . "</h3></td>
                  </tr>
				  <tr>
                      <td style='background-color:#3C3C3C'><h2>&nbsp&nbsp What's new</h2></td>
                      <td style='background-color:#3C3C3C'><h3>&nbsp&nbsp " . 'Added more blocks - 8x8' . "</h3></td>
                  </tr>";
echo "</table>";
