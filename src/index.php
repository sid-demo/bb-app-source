...
<head>
  ...
  <body style="background-color: #6D929B">
	<div  id="heading" >
...
echo "<table class='container'>
                  ...
                  <tr>
				   ...
				   <tr>
                      ...
                      <td style='background-color:#222222'><h3>&nbsp&nbsp " . '7.4.0' . "</h3></td>
                  </tr>
				  <tr>
                      <td style='background-color:#3C3C3C'><h2>&nbsp&nbsp What's new</h2></td>
                      <td style='background-color:#3C3C3C'><h3>&nbsp&nbsp " . 'Added an object to display Score ' . "</h3></td>
                  </tr>";
echo "</table>";
